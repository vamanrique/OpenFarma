...
_SUFIJOS_SAL = re.compile(
    ...
    r"CLORHIDRATO|DICLORHIDRATO|HIDROCLORURO|BROMHIDRATO|YODHIDRATO|"
    ...
    r"DIPROPIONATO|FUROATO|HEXANOATO|DECANOATO|UNDECANOATO|"
...
_SINONIMOS: dict[str, str] = {
    ...
    # Fluoroquinolonas: CUM colombiano alterna -ina (femenino) vs -ino (INN español oficial)
    ...
    "PEFLOXACINA":      "PEFLOXACINO",
    "DELAFLOXACINA":    "DELAFLOXACINO",
    # Eritropoyetinas: normalizar al INN español oficial
    ...
    # Otros: formas sin preposición "DE" más comunes en INN
    "MICOFENOLATO DE MOFETILO": "MICOFENOLATO MOFETILO",
    "MICOFENOLATO DE SODIO":    "MICOFENOLATO SODICO",
    # PICOSULFATO: variante con preposición
    "PICOSULFATO SODICO":       "PICOSULFATO DE SODIO",
    # Variantes adicionales inglés → español
    "NEOMYCIN":         "NEOMICINA",
    "NYSTATIN":         "NISTATINA",
    "POLYMYXIN":        "POLIMIXINA",
    ...
    "DOXYCYCLIN":       "DOXICICLINA",
    "RIFAMPICIN":       "RIFAMPICINA",
    ...
    "IMIPENEM":         "IMIPENEM",
    "MEROPENEM":        "MEROPENEM",
    "PIPERACILLIN":     "PIPERACILINA",
    "TAZOBACTAM":       "TAZOBACTAM",
    "CLAVULANATE":      "CLAVULANICO",
    "SULBACTAM":        "SULBACTAM",
    "ERTAPENEM":        "ERTAPENEM",
    "DORIPENEM":        "DORIPENEM",
    ...
    "MESALAZINE":       "MESALAZINA",
    "OLSALAZINE":       "OLSALAZINA",
    "BALSALAZIDE":      "BALSALAZIDA",
    "ONDANSETRON":      "ONDANSETRON",
    "GRANISETRON":      "GRANISETRÓN",
    ...
    "SUCRALFATE":       "SUCRALFATO",
    "MISOPROSTOL":      "MISOPROSTOL",
    "BISACODYL":        "BISACODILO",
    "LACTULOSE":        "LACTULOSA",
    "ATORVASTATIN":     "ATORVASTATINA",
    ...
    "NIFEDIPINE":       "NIFEDIPINO",
    "NIMODIPINE":       "NIMODIPINO",
    "FELODIPINE":       "FELODIPINO",
    "VERAPAMILE":       "VERAPAMILO",
    ...
    "DRONEDARONE":      "DRONEDARONA",
    "HEPARIN":          "HEPARINA",
    "ENOXAPARIN":       "ENOXAPARINA",
    "DALTEPARIN":       "DALTEPARINA",
    ...
    "FLUPHENAZINE":     "FLUFENAZINA",
    "THIORIDAZINE":     "TIORIDAZINA",
    ...
    "ROTIGOTINE":       "ROTIGOTINA",
    "SELEGILINE":       "SELEGILINA",
    "RASAGILINE":       "RASAGILINA",
    "ENTACAPONE":       "ENTACAPONA",
    "BACLOFEN":         "BACLOFENO",
    ...
    "AMPHOTERICIN":     "ANFOTERICINA",
    "TERBINAFINE":      "TERBINAFINA",
    "GRISEOFULVIN":     "GRISEOFULVINA",
    "NYSTATIN":         "NISTATINA",
    "FLUCYTOSINE":      "FLUCITOSINA",
    "ATOVAQUONE":       "ATOVAQUONA",
    "PRIMAQUINE":       "PRIMAQUINA",
    "ARTEMETHER":       "ARTEMETERO",
    "LUMEFANTRINE":     "LUMEFANTRINA",
    "MEFLOQUINE":       "MEFLOQUINA",
    ...
    "CROMOLYN":         "CROMOGLICATO",
    "NEDOCROMIL":       "NEDOCROMILO",
    "OMALIZUMAB":       "OMALIZUMAB",
    "ROFLUMILAST":      "ROFLUMILAST",
    "ACETYLCYSTEINE":   "ACETILCISTEINA",
    "AMBROXOL":         "AMBROXOL",
    "BROMHEXINE":       "BROMHEXINA",
    ...
    "TROPICAMIDE":      "TROPICAMIDA",
    "CYCLOPENTOLATE":   "CICLOPENTOLATO",
    "TIMOLOL":          "TIMOLOL",
    "LATANOPROST":      "LATANOPROST",
    "BIMATOPROST":      "BIMATOPROST",
    "TRAVOPROST":       "TRAVOPROST",
    "BRIMONIDINE":      "BRIMONIDINA",
    "DORZOLAMIDE":      "DORZOLAMIDA",
    "BRINZOLAMIDE":     "BRINZOLAMIDA",
    "PILOCARPINE":      "PILOCARPINA",
    "RANIBIZUMAB":      "RANIBIZUMAB",
    "BEVACIZUMAB":      "BEVACIZUMAB",
    "AFLIBERCEPT":      "AFLIBERCEPT",
    "FLUOROMETHOLONE":  "FLUOROMETOLONA",
    "PREDNISOLONE":     "PREDNISOLONA",
    "DEXAMETHASONE":    "DEXAMETASONA",
    ...
    "DICLOFENAC":       "DICLOFENACO",
    "NEOMYCIN":         "NEOMICINA",
    "TETRACAINE":       "TETRACAINA",
    "PROPARACAINE":     "PROPARACAINA",
    "OXYBUPROCAINE":    "OXIBUPROCAINA",
    ...
    "NORETHISTERONE":   "NORETISTERONA",
    "NORGESTIMATE":     "NORGESTIMATO",
    "DROSPIRENONE":     "DROSPIRENONA",
    "GESTODENE":        "GESTODENO",
    "CYPROTERONE":      "CIPROTERONA",
    ...
    "PHYTOMENADIONE":   "FITOMENADIONA",
    "VITAMIN K":        "FITOMENADIONA",
    "CALCIUM CARBONATE": "CARBONATO DE CALCIO",
    "MAGNESIUM HYDROXIDE": "HIDROXIDO DE MAGNESIO",
    "ALUMINUM HYDROXIDE": "HIDROXIDO DE ALUMINIO",
    "SIMETHICONE":      "SIMETICONA",
    "ACTIVATED CHARCOAL": "CARBON ACTIVADO",
    ...
    "GLYCERIN":         "GLICERINA",
    "SORBITOL":         "SORBITOL",
    "METHYLCELLULOSE":  "METILCELULOSA",
    "PSYLLIUM":         "PSILIO",
    "CALCIUM POLYCARBOPHIL": "POLISILICATO DE CALCIO",
    ...
    "MEBEVERINE":       "MEBEVERINA",
    "PINAVERIUM":       "PINAVERIO",
    "TRIMEBUTINE":      "TRIMEBUTINA",
    "ANTACID":          "ANTIÁCIDO",
    "PANTOPRAZOLE":     "PANTOPRAZOL",
    "LANSOPRAZOLE":     "LANSOPRAZOL",
    ...
    "ROPIVACAINE":      "ROPIVACAINA",
    "MEPIVACAINE":      "MEPIVACAINA",
    "CHLOROPROCAINE":   "CLOROPROCAINA",
    "PROCAINE":         "PROCAINA",
    "COCAINE":          "COCAINA",

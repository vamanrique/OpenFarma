...
Correcciones — posición del isótopo en nombres de radiofármacos:
  ...
  Convención: isótopo entre paréntesis DESPUÉS del nombre del compuesto base
  (ej. MOLIBDATO DE SODIO (99MO), no MOLIBDATO (99MO) DE SODIO)
  — consistente con nomenclatura IUPAC/USP y con id=3589 ya correcto en DB.

  A) MOLIBDATO (99MO) DE SODIO||PERTECNETATO (99MTC) DE SODIO
     -> MOLIBDATO DE SODIO (99MO)||PERTECNETATO DE SODIO (99MTC):
     - id=3496: IN 120g (n=2) -> sin merge (distinta conc que id=3589 que tiene 43g)
"""
...
def main():
    ...
    # -- A. MOLIBDATO (99MO) DE SODIO -> MOLIBDATO DE SODIO (99MO) --------------------
    print("\n=== A. Posición isótopo: (99MO) DE SODIO -> DE SODIO (99MO) ===")
    radio_map = {
        "MOLIBDATO (99MO) DE SODIO": "MOLIBDATO DE SODIO (99MO)",
        "PERTECNETATO (99MTC) DE SODIO": "PERTECNETATO DE SODIO (99MTC)",
    }
    n['A'] += rename_dci(con, 3496,
                         "MOLIBDATO DE SODIO (99MO)||PERTECNETATO DE SODIO (99MTC)",
                         radio_map)

...
Correcciones — nombre obsoleto y nombre inglés:
  ...
  A) HIDROXIUREA -> HIDROXICARBAMIDA (HIDROXICARBAMIDA es el INN WHO recomendado en español):
     - id=2536: HIDROXIUREA SO 500mg (n=3) -> auto-merge id=2538 (HIDROXICARBAMIDA SO 500mg, n=3->6)

  B) IOBENGUANE (I 131) -> IOBENGUANO (I-131) (inglés->español; INN español = iobenguano):
     - id=3007: IOBENGUANE (I 131) IN SIN_CONC (n=2) -> sin merge
"""
...
def main():
    ...
    # -- A. HIDROXIUREA -> HIDROXICARBAMIDA -------------------------------------------
    print("\n=== A. HIDROXIUREA -> HIDROXICARBAMIDA ===")
    n['A'] += rename_dci(con, 2536, "HIDROXICARBAMIDA", {"HIDROXIUREA": "HIDROXICARBAMIDA"})

    # -- B. IOBENGUANE (I 131) -> IOBENGUANO (I-131) ----------------------------------
    print("\n=== B. IOBENGUANE (I 131) -> IOBENGUANO (I-131) ===")
    n['B'] += rename_dci(con, 3007, "IOBENGUANO (I-131)",
                         {"IOBENGUANE (I 131)": "IOBENGUANO (I-131)"})

...
Correcciones — nombre científico extenso -> INN abreviado español:
  ...
  A) TOXINA DE CLOSTRIDIUM BOTULINUM TIPO A -> TOXINA BOTULINICA TIPO A
     (INN español OMS = toxina botulínica tipo A; nombre científico completo innecesario):
     - id=3618: IN SIN_CONC (n=2) -> auto-merge id=2881 (TOXINA BOTULINICA TIPO A SIN_CONC, n=4->6)
"""
...
def main():
    ...
    # -- A. TOXINA DE CLOSTRIDIUM BOTULINUM TIPO A -> TOXINA BOTULINICA TIPO A --------
    print("\n=== A. TOXINA DE CLOSTRIDIUM BOTULINUM TIPO A -> TOXINA BOTULINICA TIPO A ===")
    n['A'] += rename_dci(con, 3618, "TOXINA BOTULINICA TIPO A",
                         {"TOXINA DE CLOSTRIDIUM BOTULINUM TIPO A": "TOXINA BOTULINICA TIPO A"})

...
Correcciones — typo en SGLT2 inhibidor:
  ...
  A) DAPAGLIFOZINA -> DAPAGLIFLOZINA (typo: falta L; GLIFLOZINA es el sufijo correcto):
     - id=2392: DAPAGLIFOZINA SO 10mg (n=3) -> auto-merge id=1717 (n=23->26)
     - id=2394: DAPAGLIFOZINA||METFORMINA SO 5mg+1000mg (n=5) -> auto-merge id=1815 (n=6->11)
"""
...
def main():
    ...
    # -- A. DAPAGLIFOZINA -> DAPAGLIFLOZINA -------------------------------------------
    print("\n=== A. DAPAGLIFOZINA -> DAPAGLIFLOZINA ===")
    dag_map = {"DAPAGLIFOZINA": "DAPAGLIFLOZINA"}
    n['A'] += rename_dci(con, 2392, "DAPAGLIFLOZINA", dag_map)
    n['A'] += rename_dci(con, 2394, "DAPAGLIFLOZINA||METFORMINA", dag_map)
